...
extension ATProtoKit {
    ...
    /// 
    /// - Note: According to the AT Protocol specifications: "Download a repository export as CAR file. Optionally only a 'diff' since a previous revision. Does not require auth; implemented by PDS."
    ///
