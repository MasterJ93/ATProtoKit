...
extension ATProtoKit {
    ...
    public func getInviteCodesAsAdmin(sortedBy sort: AdminGetInviteCodesSort = .recent, withLimitOf limit: Int = 100, cursor: String?) async throws -> Result<AdminGetInviteCodesOutput, Error> {
