...
extension ATProtoKit {
    ...
    public static func getProfile(_ actor: ActorGetProfileQuery, accessToken: String? = nil,
                                  pdsURL: String? = "https://bsky.social") async throws -> Result<ActorGetProfileOutput, Error> {
