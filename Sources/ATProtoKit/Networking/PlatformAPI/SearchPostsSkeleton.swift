...
extension ATProtoKit {
    ...
    public func searchPostsSkeleton(_ query: String, limit: Int? = 25, cursor: String? = nil) async throws -> Result<UnspeccedSearchPostsSkeletonOutput, Error> {
        ...
        do {
            ...
            let response = try await APIClientService.sendRequest(request, decodeTo: UnspeccedSearchPostsSkeletonOutput.self)
