# Archived: 0.21 to 0.26 Authentication Flow Migration

Learn about how to set up your project with the new authentication flow changes.

> Archived: This article documents the migration from ATProtoKit 0.21 through 0.26 and is retained
> only as a historical reference. Its examples and declarations do not describe the current
> ATProtoKit API.
