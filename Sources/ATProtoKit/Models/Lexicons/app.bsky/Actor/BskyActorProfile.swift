...
///
/// - Note: According to the AT Protocol specifications: "A declaration of a Bluesky account profile."
///
...
public struct ActorProfile: Codable {
    /// The display name of the profile. Optional.
    public let displayName: String?
    /// The description of the profile. Optional.
    ///
    /// - Note: According to the AT Protocol specifications: "Free-form profile description text."
    public let description: String?
    /// The avatar image URL of the profile. Optional.
    ///
    /// - Note: According to the AT Protocol specifications: "Small image to be displayed next to posts from account. AKA, 'profile picture'"
    ///
    /// - Note: Only JPEGs and PNGs are accepted.
    public let avatarBlob: BlobContainer?
    /// The banner image URL of the profile. Optional.
    ///
    /// - Note: According to the AT Protocol specifications: "Larger horizontal image to display behind profile view."
    ///
    /// - Note: Only JPEGs and PNGs are accepted.
    public let bannerBlob: BlobContainer?
    /// An array of user-defined labels. Optional.
    ///
    /// - Note: According to the AT Protocol specifications: "Self-label values, specific to the Bluesky application, on the overall account."
