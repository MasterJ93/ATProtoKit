...
public struct ActorProfile: Codable {
    ...
    ///
    /// - Note: According to the AT Protocol specifications: "Larger horizontal image to display
    /// behind profile view."
    ///
    /// - Note: Only JPEGs and PNGs are accepted.
    ...
    ///
    /// - Note: According to the AT Protocol specifications: "Self-label values, specific to the
    /// Bluesky application, on the overall account."
