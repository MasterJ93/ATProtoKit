...
///
/// - Note: According to the AT Protocol specifications: "Get private preferences attached to the
/// current account. Expected use is synchronization between multiple devices, and
