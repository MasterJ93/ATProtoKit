//
//  AtprotoAdminEnableAccountInvites.swift
//
//
...
/// The main data model definition for giving the user account access to receive invite codes again.
///
...
public struct AdminEnableAccountInvites: Codable {
    /// The decentralized identifier (DID) of the account that will regain access to receiving invite codes.
