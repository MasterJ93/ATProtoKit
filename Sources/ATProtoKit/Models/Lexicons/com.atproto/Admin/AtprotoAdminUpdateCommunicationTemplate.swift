//
//  AtprotoAdminUpdateCommunicationTemplate.swift
//
//
...
/// The main data model definition for updating a communication template.
///
...
///
/// - SeeAlso: This is based on the [`com.atproto.admin.updateCommunicationTemplate`][github] lexicon.
///
/// [github]: https://github.com/bluesky-social/atproto/blob/main/lexicons/com/atproto/admin/updateCommunicationTemplate.json
public struct AdminUpdateCommunicationTemplate: Codable {
    ...
    /// The decentralized identifier (DID) of the user who updated the communication template. Optional.
