...
///
/// - SeeAlso: This is based on the [`com.atproto.admin.emitModerationEvent`][github] lexicon.
///
/// [github]: https://github.com/bluesky-social/atproto/blob/main/lexicons/com/atproto/admin/emitModerationEvent.json
