//
//  AtprotoServerCreateAppPassword.swift
//
//
...
/// The main data model definition for creating an App Password.
///
...
public struct ServerCreateAppPassword: Codable {
    /// The name given to the App Password to help distingush it from others.
    ///
    /// - Note: According to the AT Protocol specifications: "A short name for the App Password, to help distinguish them."
